...
var showInfo = (event) => {
    ...
    div.innerHTML = "Source: " + vid.currentSrc + "<br>" + "Duration: " + formatTime(vid.duration) + "<br>" + "Position: " + formatTime(vid.currentTime) + "<br>" + "Muted: " + (vid.muted?"true":"false") + "<br>" + "Volume: " + vid.volume + "<br>" + "Playback rate: " + vid.playbackRate + "<br>" + "Paused: " + (vid.paused?"true":"false") + "<br>" + "Ended: " + (vid.ended?"true":"false") + "<br>" + "Last event: " + event;
